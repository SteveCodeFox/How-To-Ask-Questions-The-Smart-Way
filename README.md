...
如果你决定向我们求助，当然你肯定不希望被视为“伸手党”，更不愿真的成为“伸手党”。能立刻得到问题的有效解决方案的最好方法，就是好好提问 —— 聪明、自信、有解决问题的思路，只是偶尔在难凭一己之力解决的问题上需要他人的帮助。
...
因此，第一步是找到对的论坛。再说一次，必应和其它搜索引擎还是你的朋友，用它们来找到与你遭遇到困难的软硬件问题最相关的网站。通常那儿都有常见问题（FAQ）、邮件列表及相关说明文件的链接。如果你的努力（包括**阅读** FAQ）都没有结果，网站上也许还有报告 Bug（Bug-reporting）的流程或链接，如果是这样，链过去看看。
