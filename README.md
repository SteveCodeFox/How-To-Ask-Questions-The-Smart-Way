...
和软件开发者相比，经验丰富的用户往往对那些新手经常遇到的小问题更宽容(因为他们大概率也是这么过来的)。

尽管如此，一些人仍然有着对简单问题不屑一顾的态度，这可能会让你觉得他们对新手较有敌意，但其实并非如此。

不愿动脑、或者在发问前不自己寻找方法的人只能浪费时间 —— 我们称这样的人为 “伸手党”。

大多数人都是自愿从忙碌的生活中抽空来解答问题，所以只好过滤一些无意义的问题，特别是“伸手党”的问题。

请不要用高高在上的态度“求助”，任何人都没有义务解决你的问题。大多数人非常乐意与你平等地交流，但他们大概率不会帮助“伸手党” 。不懂很正常，但别把自己当智障。
...
当你提出问题的时候，请先说明你已经做了上述的事情而都没有解决，至少别人会知道你不是那种“伸手党”

首先的首先，[百度一下](https://www.baidu.com/)，这样很可能直接就解决了问题。即使没有，在求助时加上一句 `我搜过了，但还是解决不了问题` 也是好事。

不要指望几秒钟的搜索就能解决所有问题。在求助之前，再仔细阅读一下文档，仔仔细细看一遍FAQ，花点时间思考一下问题。不要只因为你没搜到答案就把所有问题一股脑拋出。

别以为你**理应**得到答案，毕竟你没有给过他们一分钱。你是自己去**挣到**一个答案，而不是从他人那里索要知识。

另一方面，你可以表明你愿意动手做些事情。比如`谁能给点提示？`、`这里缺了什么吗？`比`我是萌新，教我`更容易得到答复。
...
上述的问题，非常容易被人忽略，你肯定不想这样。

因此，第一步是找到对的场合。再说一遍，百度一下是个不错的选择，用它们来找到与你问题最相关的网站。那里通常都有FAQ、使用文档。如果都没有结果，网站上也许还有Github链接，可以点进去注册个Github账号发Issue反馈问题。
 
先看看 FAQ 或者使用文档弄清楚你的问题是否相关。发文前先翻翻已有的Issues。事实上，事先中搜索与你问题相关的关键词是个极好的主意，这样多多少少都能帮到你。

别像机关枪似的一次“扫射”所有的求助渠道，这样的行为像猴子。解决不了再一个一个慢慢来。

搞清楚你的主题！举个例子，你在聊腾讯的产品群聊底下问阿里的产品，你就会发现没有一个人理你。
