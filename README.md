...
本指南原文英文版版权为 Eric S. Raymond, Rick Moen 所有。

原文网址：[http://www.catb.org/~esr/faqs/smart-questions.html](http://www.catb.org/~esr/faqs/smart-questions.html)

Copyleft 2001 by D.H.Grand(nOBODY/Ginux), 2010 by Gasolin, 2015 by Ryan Wu, 2024 by SteveCodeFox
...
如果你是网站的管理员并想要创建指向本指南的链接，请在链接附近的显著位置注明：
...
我们已经深刻领会到缺少该声明所带来的痛苦：有些傻瓜认为本指南有责任解决世界上所有技术问题，还总是来找我们问这类问题

如果你抱着直接寻求帮助的目的而阅读本指南，并在离开时还觉得可以从本文获得解决方案，那你就是上述的傻瓜之一。别问我们相关问题，我们不会理你。

我们只是想在这本指南中教你如何从那些真正有经验的人那里取得协助，而 99% 的情况下都不会是我们。除非你确定本指南的作者之一刚好是你所遇到的问题领域的专家，否则请不要打扰我们，让大家都开心一点。

## 简介

**由于原文历史久远，在下文中，对于“开发者”或“解答问题的人”，将使用“我们”一词代替，敬请注意**

在网络上，你的问题解答的好坏, 很大程度上取决于你提问的方式与此问题的难度。本指南将教你正确提问的方法，以帮助获得你想要的解答。

您通常可以从其他更有经验的人 (比如软件交流群里的群友) 那里获得与开发者一样好的解答，这是件**好事**；和软件开发者相比，他们往往对那些新手经常遇到的小问题更宽容。所以，以本文的方式向他们提问也是获得有效解决方案的好办法。

尽管如此，一些人仍然有着对简单问题不屑一顾的态度，这可能会让你觉得他们对新手较有敌意，但其实并非如此，不要因此而放弃提问。

坦白说，我们十分厌恶那些不愿动脑、或者在发问前不自己寻找方法的人。那些人只会浪费我们的时间 —— “有这时间去回答这些人的问题，倒不如去做些更有意义的事情。” 我们称这样的人为 “伸手党”。

我们明白，许多人只是想使用我们编写的软件，对学习技术细节不感兴趣。对大多数人而言，电脑只是种工具，是种达到目的的手段而已。他们有自己的生活并且有更要紧的事要做。我们清楚这点，也从不指望每个人都对我们钻研的技术问题感兴趣。尽管如此，我们也只会为真正感兴趣，并且愿意积极参与问题解决的人来调整回答问题的风格。这点不会变，也不应该变：不然就是在最擅长的事情上降低效率。

我们（在大多数情况下）都是自愿从忙碌的生活中抽空来解答问题，而且时常被别的提问淹没。所以我们只好过滤一些话题，特别是“伸手党”的问题，这样才能更加高效地利用时间来回答问题。

如果你讨厌我们的言行，自觉高高在上、态度傲慢，不妨试试换位思考。我们并不要求你必须屈服我们 —— 事实上，大多数人非常乐意与你平等地交流，只要你付出一点点的行动来满足基本要求，我们非常欢迎你加入我们。但让我们帮助那些不愿意动手的人是没有效率的 (这就是典型的伸手党) 。不懂很正常，但别把自己当智障。

综上所述，你不必在很懂技术才能让我们帮助你，但你必须表现出你愿意学习的态度 —— 机灵、有自己想法、善于观察、乐于自己动手解决问题。如果你做不到，我们建议你花点钱找家商业公司签个技术支持服务合同，而不是要求一个人无偿地帮助你。

如果你决定向我们求助，那你肯定不希望被视为“伸手党”，更不愿成为“伸手党”。能立刻得到问题的有效解决方案的最好方法，就是好好提问 —— 聪明、自信、有解决问题的思路，只是偶尔在难凭一己之力解决的问题上需要他人的帮助。

## 在提问之前

在你准备要通过QQ、论坛或者任何其他地方提出问题前，请先确保你做到了以下事情：

  1. 尝试在你准备提问的地方找找有没有人曾经已经提过类似问题。
  2. 尝试用搜索引擎 (必应 百度等) 找到答案。
  3. 尝试阅读软件附带的“用户手册”以找到答案。
  4. 找找软件的常见问题（FAQ）是否有你的问题。
  5. 自己检查或试验以找到解决方法。
  6. 向你身边的朋友打听以找到答案。
  7. 如果你是程序开发者，请尝试阅读源代码以找到答案。

当你提出问题的时候，请先说明你已经做了上述的事情；这将有助于让人觉得你并不是一个不劳而获且浪费别人的时间的提问者。

运用某些策略，比如先用 [Bing 搜索](https://cn.bing.com/)你所遇到的各种错误信息，这样很可能直接就找到了能解决问题的文件或邮件列表线索。即使没有结果，在寻求帮助时加上一句 `我搜过了，但还是解决不了问题` 也是件好事。

别急，不要指望几秒钟的搜索就能解决一个复杂的问题。在求助之前，再阅读一下FAQ，花点时间思考一下这个问题。他们能从你的提问看出你做了怎样的尝试；有备而来更有可能得到解答。不要只因为你没搜到答案就把所有问题一股脑拋出。

准备好你的问题，再将措辞仔细地思考一遍，因为草率的发问只能得到草率的回答，或者根本得不到解答。越是能表现出你为解决问题所作出的尝试，你越有可能得到实质性的帮助。

小心别问错了问题。如果你提了个毫不相关的问题，对方多半会一边在心里想着`蠢问题…`，一边用废话来应付你，希望你能从中汲取教训。

别以为你**应该**从别人那得到答案，毕竟你没有给过他们一分钱。你是自己去**挣到**一个答案，靠提出一个有意义、不过于简单的问题，而不是从他人那里索要知识。

另一方面，你可以表明你愿意动手做些事情。`谁能给点提示？`、`这里缺了什么吗？`以及`我要检查什么`比`教我解决办法`更容易得到答复。因为这让人觉得只要有人能指个大致的方向，你就能够解决问题。

## 当你提问时

### 慎选提问的场合

慎重选择你要提问的场合。如果你做了下述的事情，你极有可能会被忽略：

* 在与主题不合的群里问问题。
* 在探讨进阶技术问题的群问非常初级的问题；反之亦然。
* 重复同样的问题。

他们不会回答这类问题，你肯定不想让这种事发生在自己身上的。

因此，第一步是找到对的论坛。再说一次，必应和其它搜索引擎还是你的朋友，用它们来找到与你遇到困难的问题最相关的网站。通常那儿都有常见问题（FAQ）、邮件列表及相关说明文件的链接。如果你的努力（包括**阅读** FAQ）都没有结果，网站上也许还有报告 Bug（Bug-reporting）的流程或链接，如果是这样，链过去看看。

随便向陌生人私聊最可能是风险最大的事情。举例来说，别假设一个看似技术了得的人会想充当你的免费顾问。不要对你的问题有人回答抱太大希望 —— 如果你不确定，那就往别处发，或者别发。
...
因为必应索引是即时的，在看 Stack Exchange 之前先在必应搜索。有很高的几率某人已经问了一个类似的问题，而且 Stack Exchange 网站们往往会是搜索结果中最前面几个。如果你在必应上没有找到任何答案，你再到特定相关主题的网站去找。用标签（Tag）搜索能让你更缩小你的搜索结果。
...
RTFM 有一个年轻的亲戚。如果你收到`STFW（Search The Fucking Web）`的回应，回答者认为你**应该到他妈的网上搜索**。那人多半也是对的，去搜索一下吧。（更温和一点的说法是 **[必应是你的朋友](http://lmgtfy.com/)**！）
...
回答：就在我找到它的地方啊，白痴 —— 搜索引擎的那一头。天哪！难道还有人不会用 [百度](https://www.bing.com) 吗？
...
> 我用必应搜索过 "Foonly Flurbamatic 2600"，但是没找到有用的结果。谁知道上哪儿去找对这种设备编程的资料？
...
尽管对那些懒虫抱怨一声 RTFM 是正当的，但能给出文档的链接（即使只是建议个必应搜索关键词）会更好。
